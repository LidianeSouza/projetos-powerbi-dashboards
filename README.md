...
| **MiniProjeto 2 – Dashboard Comercial de Vendas** | Índice Navegável | Tela inicial com botões de navegação para os dashboards posteriores | ![Índice](../imagens/thumb_miniprojeto2_indice.png) | 
| Performance comercial com narrativa inteligente, principais influenciadores e gráfico de faixas | ![Segmentos](imagens/thumb_miniprojeto2_segmentos.png)<br>![Influenciadores](imagens/thumb_miniprojeto2_influenciadores.png)<br>![Sankey](imagens/thumb_miniprojeto2_sankey.png)<br>![Regiões](imagens/thumb_miniprojeto2_vendedores.png) |
